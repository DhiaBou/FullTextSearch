...
public:
    ...
    void addPoint(const void *datapoint, labeltype label, bool replaceDeleted = false) override;

    std::priority_queue<std::pair<dist_t, labeltype >>
    searchKnn(const void* queryData, size_t k, BaseFilterFunctor* isIdAllowed = nullptr) const override;

    virtual std::vector<std::pair<dist_t, labeltype>>
    searchKnnCloserFirst(const void* queryData, size_t k, BaseFilterFunctor* isIdAllowed = nullptr) const;
