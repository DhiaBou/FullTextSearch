#ifndef DOCUMENT_ITERATOR_OLD_HPP
#define DOCUMENT_ITERATOR_OLD_HPP
 ...
 */
class DocumentIteratorOld {
 public:
  /// Constructor.
  explicit DocumentIteratorOld(const std::string &folder_path);
...
#endif  // DOCUMENT_ITERATOR_OLD_HPP
